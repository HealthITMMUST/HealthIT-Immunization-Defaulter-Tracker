						...
						<div class="col-md-3 col-xl-2">
							...
							<div class="card">
								<div class="card-header">
									<h5 class="card-title mb-0"><i class="align-middle" data-feather="user"></i>  Profile Settings</h5>
								</div>
						...
						<div class="col-md-9 col-xl-10">
							<div class="tab-content">
								<div class="tab-pane fade show active" id="password" role="tabpanel">
									...
									<div class="card">
										<div class="card-header">
											<h5 class="card-title mb-0">Change your account's password</h5>
										</div>
										<div class="card-body">
											<form>
												<div class="mb-3">
								...
								<div class="tab-pane fade" id="logout" role="tabpanel">
									<div class="card">
										<div class="card-body">
											...
											<br>
											<form method="POST">
											<button type="submit" class="btn btn-primary" onclick="'index.php'" name="confirmLogout">Yes</button>
