		...
		<nav id="sidebar" class="sidebar">
          ...
          <span class="align-middle">Immunization Tracker</span>
              ...
              <i class="align-middle" data-feather="message-circle"></i> <span class="align-middle">SMS Reminders</span>
					...
					<li class="sidebar-item">
						<a class="sidebar-link" href="current-stock.php.php">
			...
			<main class="content">
				<div class="row mb-2 mb-xl-3">
							<div class="col-auto d-none d-sm-block">
								<h3></strong> Queued Appointments</h3>
							</div>
							...
							<div class="col-auto ml-auto text-right mt-n1">
								<nav aria-label="breadcrumb">
									<ol class="breadcrumb bg-transparent p-0 mt-1 mb-0">
										...
										<li class="breadcrumb-item active" aria-current="page">Queued Appointments</li>
